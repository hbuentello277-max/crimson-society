...
export function WeeklyReportPanel({ report }: { report: WeeklyExecutiveReport }) {
  return (
    <section className="space-y-3">
      <div>
        <p className="text-[10px] uppercase tracking-[0.28em] text-[#e87a82]">Weekly Report</p>
      ...
      <div className="grid gap-3 lg:grid-cols-2">
        <ReportBlock title="Growth" headline={report.growth_summary.headline} bullets={report.growth_summary.bullets} />
