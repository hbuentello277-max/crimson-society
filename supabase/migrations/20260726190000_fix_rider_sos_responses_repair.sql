-- Repair for 20260726180000_rider_sos_responses.sql.
-- Root cause: trailing comma in responder_bike_info() COALESCE().
--
-- If 20260726180000 failed before completing, mark it applied, then push:
--   supabase migration repair --status applied 20260726180000
--   supabase db push
