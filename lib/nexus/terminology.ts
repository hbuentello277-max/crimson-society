...
const DISPLAY_REPLACEMENTS: Array<[string, string]> = [
  ...
  ["strategic mission scoring", "strategic platform scoring"],
  ["mission scoring", "platform scoring"],
  ["weigh down mission status", "weigh down Platform Status"],
  ["mission status", "Platform Status"],
  ["User workflow status", "Platform workflow status"],
  ["User workflows are", "Platform workflows are"],
  ["Platform health score", "Platform Score"],
  ["Platform Health score", "Platform Score"],
  ["workflow health score", "Platform Score"],
  ["Platform score is", "Platform Score is"],
  ["mission risk", "platform risk"],
  ["current mission", "current platform"],
  ["Mission Dashboard", "Founder Dashboard"],
  ["Mission Operations", "Platform Operations"],
  ["mission operations", "platform operations"],
  ["Mission Intelligence", "Platform Intelligence"],
  ["mission intelligence", "platform intelligence"],
  ...
  ["Platform Insights", "Platform Intelligence"],
];
