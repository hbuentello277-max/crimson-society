...
/** Dock controls slightly inside the full home-indicator inset (nav, DM composer). */
export const MOBILE_BOTTOM_SAFE_INSET = "max(4px, calc(env(safe-area-inset-bottom) - 6px))";
