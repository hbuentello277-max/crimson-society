...
export async function GET() {
  ...
  try {
    const report = await getMonthlyExecutiveReport(session.supabase);
    ...
    const message = error instanceof Error ? error.message : "Failed to load monthly executive report.";
