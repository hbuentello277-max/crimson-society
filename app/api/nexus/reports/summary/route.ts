...
export async function GET() {
  ...
  try {
    const report = await getExecutiveReportSummary(session.supabase);
    ...
    const message = error instanceof Error ? error.message : "Failed to load executive report summary.";
