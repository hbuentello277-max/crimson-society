...
const statusBackgrounds = [
  { id: "noir", label: "Noir", className: "bg-gradient-to-br from-[#050505] via-[#0c0c0d] to-[#050505]" },
  { id: "crimson", label: "Crimson", className: "bg-gradient-to-br from-[#3a0709] via-[#b4141e] to-[#3a0709]" },
  { id: "carbon", label: "Carbon", className: "bg-gradient-to-br from-[#1a1a1c] via-[#2a2a2e] to-[#0a0a0c]" },
  { id: "ember", label: "Ember", className: "bg-gradient-to-br from-[#1a0405] via-[#6a0d14] to-[#0a0102]" },
];
...
export default function CreatePage() {
  ...
  const mockRiders = [
    { id: "1", name: "Marco Vélez", handle: "@nightrider", photo: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=200" },
    { id: "2", name: "Elena Ruiz", handle: "@ironsaint", photo: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200" },
    { id: "3", name: "Devin Cole", handle: "@blackmass", photo: "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=200" },
    { id: "4", name: "Aiyana Cross", handle: "@savagegrace", photo: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200" },
    { id: "5", name: "Roman Petrov", handle: "@longshadow", photo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200" },
    { id: "6", name: "Sofia Marín", handle: "@redveil", photo: "https://images.unsplash.com/photo-1502685104226-ee32379fefbe?w=200" },
  ];

  useEffect(() => {
    // reset payload-specific fields when switching types
    if (type !== "photo") setPhotos([]);
    if (type !== "reel") setVideo(null);
    if (type !== "status") setStatusText("");
  }, [type]);
  ...
  const canPost = () => {
    ...
    if (type === "reel") return video !== null;
    ...
    <main className="min-h-screen bg-[#050505] pb-32 text-white">
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#050505]/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-2xl items-center justify-between px-5 py-4">
          <Link href="/dashboard" className="text-xs uppercase tracking-[0.3em] text-white/50 hover:text-white">
            ← Cancel
          </Link>
          <div className="text-center">
            <p className="text-[10px] uppercase tracking-[0.4em] text-[#e87a82]">Compose</p>
      ...
      <div className="mx-auto max-w-2xl px-5 pt-6">
        ...
        {type === "photo" && (
          <section className="space-y-4">
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[#0c0c0d] to-[#070707] p-5">
              <p className="mb-3 text-[10px] uppercase tracking-[0.35em] text-white/40">Frames</p>
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  {photos.length < 6 && (
                    ...
                    >
                      ...
                      <span className="text-[10px] uppercase tracking-[0.25em]">Add</span>
                    </button>
                  )}
                </div>
              )}
        ...
        {type === "reel" && (
          <section className="space-y-4">
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[#0c0c0d] to-[#070707] p-5">
              <p className="mb-3 text-[10px] uppercase tracking-[0.35em] text-white/40">Reel</p>
              ...
              {!video ? (
                ...
                <div className="relative overflow-hidden rounded-xl border border-white/10 bg-black">
                  <video src={video} controls className="h-80 w-full object-cover" />
                  <button
              ...
              <div className="mt-4 rounded-xl border border-white/10 bg-black/40 p-3">
                <p className="mb-2 text-[10px] uppercase tracking-[0.3em] text-white/40">Soundtrack</p>
        ...
        {type === "status" && (
          <section className="space-y-4">
            ...
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[#0c0c0d] to-[#070707] p-4">
              <p className="mb-3 text-[10px] uppercase tracking-[0.35em] text-white/40">Backdrop</p>
        ...
        {/* Caption (shared except status) */}
        {type !== "status" && (
          <div className="mt-4 rounded-2xl border border-white/10 bg-gradient-to-b from-[#0c0c0d] to-[#070707] p-4">
            <p className="mb-2 text-[10px] uppercase tracking-[0.35em] text-white/40">Caption</p>
            <textarea
              value={caption}
        ...
        {/* Location */}
        <div className="mt-4 rounded-2xl border border-white/10 bg-gradient-to-b from-[#0c0c0d] to-[#070707] p-4">
          <p className="mb-2 text-[10px] uppercase tracking-[0.35em] text-white/40">Location</p>
          <div className="flex items-center gap-2">
            <span className="text-[#e87a82]">⌖</span>
            <input
              value={location}
        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-gradient-to-b from-[#0c0c0d] to-[#070707] p-4">
          ...
          >
            <div className="text-left">
              <p className="text-[10px] uppercase tracking-[0.35em] text-white/40">Tag Riders</p>
        ...
        {/* Audience */}
        <div className="mt-4 rounded-2xl border border-white/10 bg-gradient-to-b from-[#0c0c0d] to-[#070707] p-4">
          <p className="mb-3 text-[10px] uppercase tracking-[0.35em] text-white/40">Audience</p>
          <div className="grid grid-cols-3 gap-2">
            {(
              [
              ...
              ] as { id: Audience; label: string; sub: string }[]
            ).map((opt) => (
              <button
                key={opt.id}
              ...
              >
                <p className="text-xs uppercase tracking-[0.2em] text-white">{opt.label}</p>
          ...
          <>
            ...
            <article className="overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-[#0c0c0d] to-[#070707]">
              ...
              {type === "status" && statusText && (
                <div className={`flex min-h-[240px] items-center justify-center p-8 ${statusBg.className}`}>
                  <p className="text-center font-serif text-2xl italic text-white">{statusText}</p>
                </div>
              )}
        ...
        >
          ...
          >
            <div className="mb-4 flex items-center justify-between">
              <div>
                <p className="text-[10px] uppercase tracking-[0.35em] text-[#e87a82]">Tag</p>
                <h2 className="font-serif text-2xl italic text-white">Riders</h2>
              </div>
              <button
                onClick={() => setShowRiderPicker(false)}
                  ...
                  >
                    ...
                    <div
                      className={`flex h-6 w-6 items-center justify-center rounded-full border ${
                        isTagged ? "border-[#b4141e] bg-[#b4141e] text-white" : "border-white/20"
                      }`}
                    >
                      {isTagged ? "✓" : ""}
                    </div>
