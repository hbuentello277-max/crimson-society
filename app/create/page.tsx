...
export default function CreatePage() {
  ...
  const handlePhotos = (files: FileList | null) => {
    ...
    const maxPhotos = type === "photo" ? MAX_POST_PHOTOS : GARAGE_BUILD_PHOTO_LIMIT;
    ...
    setPhotos((prev) => {
      if (type === "garage_build") {
        ...
        return incoming.slice(0, maxPhotos);
      }
    ...
    try {
      ...
      if (type === "photo" && photos.length > 0) {
        ...
        for (const photo of photos) {
          ...
          imageOriginals.push(original);
          imageDisplays.push(display);
